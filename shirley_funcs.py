...
shapes = ["triangle","circle","triangle","arrow","turtle","classic"]

# def change_shape(simulation):
#          random_index = random.shapes(len(list))
#          self.turtle.shape(shapes[random_index])
def add_vel(simulation):
    simulation.x_vel += 10
    simulation.y_vel += 10
